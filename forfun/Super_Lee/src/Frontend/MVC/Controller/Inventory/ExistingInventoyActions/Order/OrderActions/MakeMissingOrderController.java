...
public class MakeMissingOrderController implements ActionListener {
    private MakeMissingOrderView view;
    private int invID;
    private FactoryModel factoryModel;
    private String worker;

    public MakeMissingOrderController(FactoryModel factoryModel, MakeMissingOrderView view, int invID, String worker){
        this.worker = worker;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==view.makeOrderButton){
            ...
            if(valid & !missingItems.isEmpty()){
                output = factoryModel.makeMissingReport(invID, missingItems);
            }
            else{
