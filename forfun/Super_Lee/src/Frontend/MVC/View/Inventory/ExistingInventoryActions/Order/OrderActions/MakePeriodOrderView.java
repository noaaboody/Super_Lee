...
import Frontend.MVC.Controller.Inventory.ExistingInventoyActions.Order.OrderActions.MakePeriodOrderController;
import Frontend.MVC.Model.FactoryModel;
import Frontend.MVC.View.Inventory.PopUpView;

import javax.swing.*;

public class MakePeriodOrderView extends JFrame {
    ...
    private MakePeriodOrderController controller;
    public JButton backButton;

    public MakePeriodOrderView(FactoryModel factoryModel, int invID, String worker){
        controller = new MakePeriodOrderController(factoryModel,this, invID, worker);

        supplierIdLabel = new JLabel();
        supplierIdLabel.setBounds(30,20,100,20);
        supplierIdLabel.setText("Supplier ID:");

        supplierIdField = new JTextField();
        supplierIdField.setBounds(110,20,100,20);
        supplierIdField.addActionListener(controller);

        Label1 = new JLabel();
        Label1.setBounds(30,90,10,20);
        Label1.setText("1.");

        Label2 = new JLabel();
        Label2.setBounds(30,120,10,20);
        Label2.setText("2.");

        Label3 = new JLabel();
        Label3.setBounds(30,150,10,20);
        Label3.setText("3.");

        Label4 = new JLabel();
        Label4.setBounds(30,180,10,20);
        Label4.setText("4.");

        Label5 = new JLabel();
        Label5.setBounds(30,210,10,20);
        Label5.setText("5.");

        Label6 = new JLabel();
        Label6.setBounds(30,240,10,20);
        Label6.setText("6.");

        Label7 = new JLabel();
        Label7.setBounds(30,270,10,20);
        Label7.setText("7.");

        Label8 = new JLabel();
        Label8.setBounds(30,300,10,20);
        Label8.setText("8.");

        itemIdLabel = new JLabel();
        itemIdLabel.setBounds(50,60,150,20);
        itemIdLabel.setText("Item id");

        itemIdField1 = new JTextField();
        itemIdField1.setBounds(50,90,150,20);
        itemIdField1.addActionListener(controller);

        itemIdField2 = new JTextField();
        itemIdField2.setBounds(50,120,150,20);
        itemIdField2.addActionListener(controller);

        itemIdField3 = new JTextField();
        itemIdField3.setBounds(50,150,150,20);
        itemIdField3.addActionListener(controller);

        itemIdField4 = new JTextField();
        itemIdField4.setBounds(50,180,150,20);
        itemIdField4.addActionListener(controller);

        itemIdField5 = new JTextField();
        itemIdField5.setBounds(50,210,150,20);
        itemIdField5.addActionListener(controller);

        itemIdField6 = new JTextField();
        itemIdField6.setBounds(50,240,150,20);
        itemIdField6.addActionListener(controller);

        itemIdField7 = new JTextField();
        itemIdField7.setBounds(50,270,150,20);
        itemIdField7.addActionListener(controller);

        itemIdField8 = new JTextField();
        itemIdField8.setBounds(50,300,150,20);
        itemIdField8.addActionListener(controller);

        quantityLabel = new JLabel();
        quantityLabel.setBounds(220,60,150,20);
        quantityLabel.setText("Quantity");

        quantityField1 = new JTextField();
        quantityField1.setBounds(220,90,150,20);
        quantityField1.addActionListener(controller);

        quantityField2 = new JTextField();
        quantityField2.setBounds(220,120,150,20);
        quantityField2.addActionListener(controller);

        quantityField3 = new JTextField();
        quantityField3.setBounds(220,150,150,20);
        quantityField3.addActionListener(controller);

        quantityField4 = new JTextField();
        quantityField4.setBounds(220,180,150,20);
        quantityField4.addActionListener(controller);

        quantityField5 = new JTextField();
        quantityField5.setBounds(220,210,150,20);
        quantityField5.addActionListener(controller);

        quantityField6 = new JTextField();
        quantityField6.setBounds(220,240,150,20);
        quantityField6.addActionListener(controller);

        quantityField7 = new JTextField();
        quantityField7.setBounds(220,270,150,20);
        quantityField7.addActionListener(controller);

        quantityField8 = new JTextField();
        quantityField8.setBounds(220,300,150,20);
